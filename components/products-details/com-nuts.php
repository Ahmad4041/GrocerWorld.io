  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="product-gallery">
        <img
          id="mainImage"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTcVfud5XKGzvbJJvs98atZbxElw01bT9Ki6w&s"
          alt="Product Image"
          class="img-fluid"
        />
        <div class="image-nav">
      ...
      <div class="row product-thumbnails mt-4">
        ...
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 1)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHh2v5eMjT6SbCEAAX72u0sAj8DDUA4n9K9Q&s"
              alt="Thumbnail 2"
            />
          </div>
        </div>
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 2)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvT-j6KstKqYKE7kFiAWhU4QL2EvmbRCFafw&s"
              alt="Thumbnail 3"
            />
          </div>
        </div>
