<div class="container mt-5">
      ...
      <div class="row product-thumbnails mt-4">
        ...
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 1)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSD0wBBR-bXUM6jcN5u8QtOCdvbBOF-Zw3Q-g&s"
              alt="Thumbnail 2"
            />
          </div>
        </div>
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 2)">
            <img
              src="https://foodfusion.com/wp-content/uploads/2021/04/Bakery-biscuits-Recipe-by-Food-fusion-5.jpg"
              alt="Thumbnail 3"
            />
          </div>
        </div>
  ...
  <div class="available-size">
    ...
    <select class="form-select" id="sizeSelect">
      <option value="1kg" data-price="10.50">1kg</option>
      <option value="5kg" data-price="20.00">5kg</option>
      <option value="10kg" data-price="35.00">10kg</option>
  ...
  <!-- <button class="btn btn-success btn-lg w-100 add-to-cart" data-id="1"
    ...
    <button class="btn btn-success btn-lg w-100 add-to-cart  "  data-id="18" data-name="Biscuits" data-price="10.50"   onclick="addToCart(this)">
  Add to Cart
</button>
