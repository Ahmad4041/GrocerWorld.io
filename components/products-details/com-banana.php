<div class="container mt-5">
      ...
      <div class="row product-thumbnails mt-4">
        ...
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 1)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWGFc2XAS8InSqHoSLQld5pC_tmu8fisWdXA&s"
              alt="Thumbnail 2"
            />
          </div>
        </div>
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 2)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTj2ICHY2KTVL4BJR2N6PZhVShKH5O1U2IP8w&s"
              alt="Thumbnail 3"
            />
          </div>
        </div>
  ...
  <!-- <button class="btn btn-success btn-lg w-100 add-to-cart" data-id="1"
    ...
    <button class="btn btn-success btn-lg w-100 add-to-cart  "  data-id="30" data-name="Banana" data-price="5.00"   onclick="addToCart(this)">
  Add to Cart
</button>
