<div class="container mt-5">
      ...
      <div class="row product-thumbnails mt-4">
        ...
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 1)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIApGEemKE80qpDIplXdFm3QQjIzQDWtELhQ&s"
              alt="Thumbnail 2"
            />
          </div>
        </div>
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 2)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSADEnKzWzJM2ykhE4CGWqkBrYNmZwb7iDHfg&s"
              alt="Thumbnail 3"
            />
          </div>
        </div>
  ...
  <div class="quantity-section">
    ...
    <button class="btn btn-success btn-lg w-100 add-to-cart" data-id="21" data-name="Onion " data-price="3" onclick="addToCart(this)">
  Add to Cart
</button>
