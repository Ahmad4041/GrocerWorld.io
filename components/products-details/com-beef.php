<div class="container mt-5">
      ...
      <div class="row product-thumbnails mt-4">
        ...
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 1)">
            <img
              src="https://www.thespruceeats.com/thmb/AsHVWEq5JaotXjMIvrs1wKU8WaM=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/JMTalbott-466838246c734494b30bcf47b633e116.jpg"
              alt="Thumbnail 2"
            />
          </div>
        </div>
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 2)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0GQd8vBsH-XY_XazFBOC3pw98VcIkepfxDg&s"
              alt="Thumbnail 3"
            />
          </div>
        </div>
  ...
  <div class="available-size">
    ...
    <select class="form-select" id="sizeSelect">
      <option value="Beef 2KG" data-price="10.00">Beef 2KG</option>
      <option value="Mutton 2KG" data-price="20.00">Mutton 2KG</option>
  ...
  <!-- <button class="btn btn-success btn-lg w-100 add-to-cart" data-id="1"
    ...
    <button class="btn btn-success btn-lg w-100 add-to-cart  "  data-id="28" data-name="Beef & Mutton" data-price="10.00"   onclick="addToCart(this)">
  Add to Cart
</button>
