<div class="container mt-5">
      ...
      <div class="row product-thumbnails mt-4">
        ...
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 1)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS26LT2v5Ne1Ep9FGSZ-61YbUfq1otHMZGpVFCd9mUVRnFIGYTz906GoNU1kFiyiyjG_JI&usqp=CAU"
              alt="Thumbnail 2"
            />
          </div>
        </div>
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 2)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWUq2L80PAqZuKQrCdBO90igi-reHtFFz8hg&s"
              alt="Thumbnail 3"
            />
          </div>
        </div>
  ...
  <div class="available-size">
    ...
    <select class="form-select" id="sizeSelect">
      <option value="10piece" data-price="15.00">25piece</option>
      <option value="20piece" data-price="30.00">25piece</option>
      <option value="25piece" data-price="35.00">25piece</option>
    </select>
  </div>
  ...
  <div class="quantity-section">
    ...
    <button class="btn btn-success btn-lg w-100 add-to-cart" data-id="26" data-name="Paratha" data-price="3" onclick="addToCart(this)">
  Add to Cart
</button>
