<div class="container mt-5">
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="product-gallery">
        <img
          id="mainImage"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZQi4Fp1tMI-aLuAGH-sEGDbvlvPrsb-7Wzw&s"
          alt="Product Image"
          class="img-fluid"
        />
        <div class="image-nav">
      ...
      <div class="row product-thumbnails mt-4">
        ...
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 1)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuthKk-FHVDqcyFVp4b9RMzPJlnnwZRqwngA&s"
              alt="Thumbnail 2"
            />
          </div>
        </div>
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 2)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSj3T2nIOpcb7Lz3XycRavAzmKL9mVxuuE6A&s"
              alt="Thumbnail 3"
            />
          </div>
        </div>
  ...
  <div class="quantity-section">
    ...
    <button class="btn btn-success btn-lg w-100 add-to-cart" data-id="8" data-name="Fresh Dry Fish" data-price="15.00" onclick="addToCart(this)">
  Add to Cart
</button>
