<div class="container mt-5">
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="product-gallery">
        <img
          id="mainImage"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTF9WAm1-yylcc0heKUgpPd_xIF9Dp0wyGHPg&s"
          alt="Product Image"
          class="img-fluid"
        />
        <div class="image-nav">
      ...
      <div class="row product-thumbnails mt-4">
        ...
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 1)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnj7ne3Yfe5jJcc9kI93Fgj3nHlHHMUXkxEA&s"
              alt="Thumbnail 2"
            />
          </div>
        </div>
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 2)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQR1APmTjiSZRaUn45m_KXklHF7cJppgD1POg&s"
              alt="Thumbnail 3"
            />
          </div>
        </div>
  ...
  <div class="available-size">
    ...
    <select class="form-select" id="sizeSelect">
      <option value="5litr" data-price="5.00">5kg</option>
      <option value="10litr" data-price="10.00">10kg</option>
      <option value="15litr" data-price="15.00">15kg</option>
    </select>
  </div>
  ...
  <div class="quantity-section">
    ...
    <button class="btn btn-success btn-lg w-100 add-to-cart" data-id="11" data-name="Fresh Strawbery" data-price="5.00" onclick="addToCart(this)">
  Add to Cart
</button>
