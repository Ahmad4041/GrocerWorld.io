<div class="container mt-5">
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="product-gallery">
        <img
          id="mainImage"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTnA7p9enP7G51R4QhSxEoV1sXAabeFl6Y1PA&s"
          alt="Product Image"
          class="img-fluid"
        />
        <div class="image-nav">
      ...
      <div class="row product-thumbnails mt-4">
        ...
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 1)">
            <img
              src="https://ifoodreal.com/wp-content/uploads/2018/03/FG-instant-pot-yogurt.jpg"
              alt="Thumbnail 2"
            />
          </div>
        </div>
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 2)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS_V6W1y-8h697mnh5DqpOT6NWEfrlNfbVBmA&s"
              alt="Thumbnail 3"
            />
          </div>
        </div>
  ...
  <div class="available-size">
    ...
    <select class="form-select" id="sizeSelect">
      ...
      <option value="10kg" data-price="6.00">10kg</option>
      <option value="15kg" data-price="9.00">15kg</option>
    </select>
  </div>
  ...
  <button class="btn btn-success btn-lg w-100 add-to-cart" data-id="6" data-name="Sweet Yogurt" data-price="3.00" onclick="addToCart(this)">
  Add to Cart
</button>
