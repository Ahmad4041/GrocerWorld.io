<div class="container mt-5">
      ...
      <div class="row product-thumbnails mt-4">
        ...
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 1)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTX6BdlTVIQD036cBKf3WAmpQXvS6_Q89IpqA&s"
              alt="Thumbnail 2"
            />
          </div>
        </div>
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 2)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0IjNX9Fi-XW3emA1UgiFVVV4tY3slM1iQPA&s"
              alt="Thumbnail 3"
            />
          </div>
        </div>
  ...
  <div class="available-size">
    ...
    <select class="form-select" id="sizeSelect">
      <option value="500gm" data-price="8.50">500gm</option>
      <option value="1kg" data-price="10.00">1kg</option>
      <option value="2kg" data-price="12.00">2kg</option>
    </select>
  </div>
  ...
  <!-- <button class="btn btn-success btn-lg w-100 add-to-cart" data-id="1"
    ...
    <button class="btn btn-success btn-lg w-100 add-to-cart  "  data-id="33" data-name="Custard" data-price="8.50"   onclick="addToCart(this)">
  Add to Cart
</button>
