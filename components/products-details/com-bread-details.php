<div class="container mt-5">
      ...
      <div class="row product-thumbnails mt-4">
        ...
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 1)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0FSU0tTmBiXw2WoL4_OeOpEgGeWL6CKYodg&s"
              alt="Thumbnail 2"
            />
          </div>
        </div>
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 2)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSa-pL6fRTkFeaFnibnQJFIfkokG-BFu1c7D5mus61jTNtKnjxB8Vzs-58mRT2xKbuLYvI&usqp=CAU"
              alt="Thumbnail 3"
            />
          </div>
        </div>
  ...
  <div class="available-size">
    ...
    <select class="form-select" id="sizeSelect">
      <option value="Small" data-price="1.50">Small</option>
      <option value="Large" data-price="4.00">Large</option>
      <option value="Sandwitch" data-price="5.00">Sandwitch</option>
      <option value="Milky" data-price="5.00">Milky</option>
      <option value="SugarFree" data-price="2.00">SugarFree</option>
    </select>
  </div>
  ...
  <!-- <button class="btn btn-success btn-lg w-100 add-to-cart" data-id="1"
    ...
    <button class="btn btn-success btn-lg w-100 add-to-cart  "  data-id="16" data-name="Fresh Bread" data-price="1.50"   onclick="addToCart(this)">
  Add to Cart
</button>
