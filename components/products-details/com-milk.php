<div class="container mt-5">
      ...
      <div class="row product-thumbnails mt-4">
        ...
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 1)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTeWLv_AcjnQithuHxwUz7HYuNb5HqWCOgADQ&s"
              alt="Thumbnail 2"
            />
          </div>
        </div>
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 2)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRY6S1_hrd0JNPd1zXkyeXTkkiYw3UwhUZV4g&s"
              alt="Thumbnail 3"
            />
          </div>
        </div>
  ...
  <div class="available-size">
    ...
    <select class="form-select" id="sizeSelect">
      <option value="5litr" data-price="5.00">5litr</option>
      <option value="10litr" data-price="10.00">10litr</option>
      <option value="15litr" data-price="15.00">15litr</option>
    </select>
  </div>
  ...
  <div class="quantity-section">
    ...
    <button class="btn btn-success btn-lg w-100 add-to-cart" data-id="9" data-name="Fresh Milk" data-price="5.00" onclick="addToCart(this)">
  Add to Cart
</button>
