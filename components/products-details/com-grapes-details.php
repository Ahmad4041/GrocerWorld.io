<div class="container mt-5">
      ...
      <div class="row product-thumbnails mt-4">
        ...
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 1)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQldKhof5qcnxPz6c8JvYNDwC1S0zbJuPXckw&s"
              alt="Thumbnail 2"
            />
          </div>
        </div>
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 2)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMMddOtKs8mmf803yyfxZcHSusfqQZKqxxzA&s"
              alt="Thumbnail 3"
            />
          </div>
        </div>
  ...
  <div class="available-size">
    ...
    <select class="form-select" id="sizeSelect">
      <option value="5kg" data-price="3.50">5kg</option>
      <option value="8kg" data-price="5.00">8kg</option>
      <option value="10kg" data-price="8.00">10kg</option>
    </select>
  </div>
  ...
  <!-- <button class="btn btn-success btn-lg w-100 add-to-cart" data-id="1"
    ...
    <button class="btn btn-success btn-lg w-100 add-to-cart  "  data-id="15" data-name="Fresh Grapes" data-price="3.50"   onclick="addToCart(this)">
  Add to Cart
</button>
