<div class="container mt-5">
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="product-gallery">
        <img
          id="mainImage"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRBxlIgBdEzGwB16mcUa95TP0P8Iv0s7rFyzg&s"
          alt="Product Image"
          class="img-fluid"
        />
        <div class="image-nav">
      ...
      <div class="row product-thumbnails mt-4">
        ...
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 1)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-wBAkHJpfCNbjGtDbEhvjkJXTGcIkw_x2Ng&s"
              alt="Thumbnail 2"
            />
          </div>
        </div>
        <div class="col-3">
          <div class="thumbnail-item" onclick="changeImage(this, 2)">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_GUNXnzQ9LM1mBu9XTjNjhfvMPLusyura0w&s"
              alt="Thumbnail 3"
            />
          </div>
        </div>
  ...
  <div class="available-size">
    ...
    <select class="form-select" id="sizeSelect">
      ...
      <option value="15kg" data-price="15.00">15kg</option>
    </select>
  </div>
  ...
  <!-- <button class="btn btn-success btn-lg w-100 add-to-cart" data-id="1"
    ...
    <button class="btn btn-success btn-lg w-100 add-to-cart" data-id="10" data-name="Fresh Oranges" data-price="5.00" onclick="addToCart(this)">
  Add to Cart
</button>
